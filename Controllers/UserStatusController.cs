...
namespace MPGC_API.Controllers
{
    ...
    public class UserStatusController : ControllerBase
    {
        ...
        public UserStatusController(MPGCContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<UserStatus>> PostUserStatus(UserStatus userStatus)
        {
            ...
            {
                if (UserStatusExists(userStatus.IduserStatus))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetUserStatus", new { id = userStatus.IduserStatus }, userStatus);
        }
        ...
        {
            return _context.UserStatuses.Any(e => e.IduserStatus == id);
        }
    }
}
